...
export default function Contact() {
    ...
    return (
        <section className="py-20 relative z-30" id="contact">
                    ...
                    >
                        ...
                        <div className="mt-8">
                            ...
                            <div className="flex flex-wrap gap-3 mt-8">
                                <a href="https://linkedin.com/in/niravlakhani" target="_blank" className="px-5 py-2.5 rounded-full bg-white/5 border border-white/10 text-white/80 hover:bg-white/10 hover:border-white/20 hover:text-white transition-all flex items-center gap-2 group text-sm">
                                    LinkedIn <span className="text-white/40 group-hover:text-white transition-colors">↗</span>
                                </a>
                                <a href="https://behance.net/niravlakhani" target="_blank" className="px-5 py-2.5 rounded-full bg-white/5 border border-white/10 text-white/80 hover:bg-white/10 hover:border-white/20 hover:text-white transition-all flex items-center gap-2 group text-sm">
                                    Behance <span className="text-white/40 group-hover:text-white transition-colors">↗</span>
                                </a>
                                <a href="https://dribbble.com/niravlakhani" target="_blank" className="px-5 py-2.5 rounded-full bg-white/5 border border-white/10 text-white/80 hover:bg-white/10 hover:border-white/20 hover:text-white transition-all flex items-center gap-2 group text-sm">
